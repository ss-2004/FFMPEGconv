...
class FileRSZ extends JFrame implements ActionListener {
    ...
    void placeLabels() {
        ...
        JLabel FileLoc = new JLabel("Selected File : ");
        FileLoc.setFont(new Font("Courier", Font.PLAIN, 15));
        FileLoc.setSize(200, 20);
        FileLoc.setLocation(25, 225);
        FileLoc.setForeground(Color.WHITE);
        c.add(FileLoc);
    }
    ...
    void placeFields() {
        ...
        tFileLoc = new JTextArea();
        tFileLoc.setFont(new Font("Courier", Font.PLAIN, 15));
        tFileLoc.setSize(400, 20);
        tFileLoc.setLocation(175, 225);
        c.add(tFileLoc);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (choice == choose) {
            ...
            tFileLoc.setText(inputFile);

            try {
                if (tRszFileLoc.getText().equals("")) {
            ...
            if (vidFRMT.indexOf(extIN) * vidFRMT.indexOf(extOUT) < 0) {
            ...
            } else if (vidFRMT.indexOf(extIN) < 0 && imgFRMT.indexOf(extOUT) < 0) {
                if(!isPDF) {
                    ffmpegStatus.setForeground(Color.RED);
                ...
                ffmpegStatus.setForeground(Color.ORANGE);
                ffmpegStatus.setText("SELECT SIZE FOR PROCESSING...");
            }
